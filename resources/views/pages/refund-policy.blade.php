                                            ...
                                            <div class="elementor-widget-container">
                                              <div class="elementor-text-editor elementor-clearfix">
                                                ...
                                                <p>We have a 30-day return policy, which means you have 30 days after receiving your item to request a return.&nbsp;
                                                  <span style="font-size: 16px; letter-spacing: 0px;">To be eligible for a return, your item must be in the same condition that you received it, unworn or unused, with tags, and in its original packaging.
                                                    You’ll also need the receipt or proof of purchase.&nbsp;</span><span style="font-size: 16px; letter-spacing: 0px;">To start a return, you can contact us at info@mena-speakers.com. If your return is accepted,
                                                ...
                                                <p>Certain types of items cannot be returned, like perishable goods (such as food, flowers, or plants),
                                                  ...
                                                  <span style="font-size: 16px; letter-spacing: 0px;">Unfortunately, we cannot accept returns on sale items or gift cards.</span></p><p><span style="font-size: 16px; letter-spacing: 0px;"><b>Exchanges</b></span></p><p><span style="font-size: 16px; letter-spacing: 0px;">
                                                    The fastest way to ensure you get what you want is to return the item you have, and once the return is accepted, make a separate purchase for the new item.</span></p>
