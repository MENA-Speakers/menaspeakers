        ...
        <div className="max-w-7xl mx-auto py-8 grid grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="mt-4 space-x-6 flex ">
              ...
              <a href="https://www.instagram.com/menaspeakers" target="_blank" className={"hover:-translate-y-1.5 hover:duration-200"}>
              ...
              <a href="https://www.linkedin.com/company/10342646" target="_blank" className={"hover:-translate-y-1.5 hover:duration-200"}>
              ...
              <a href="https://www.twitter.com/menaspeakers" target="_blank" className={"hover:-translate-y-1.5 hover:duration-200"}>
              ...
              <a href="https://www.youtube.com/@menaspeakers4868" target="_blank" className={"hover:-translate-y-1.5 hover:duration-200"}>
