    ...
    <MainLayout>
      ...
      <section className="py-12 px-6 lg:px-0">
        <div className={"max-w-6xl mx-auto space-y-3"}>
          ...
          <p>
            “ https://mena-speakers.com will not pass any debit/credit card
            details to third parties’’
          </p>
          <p>
            "https://mena-speakers.com takes appropriate steps to ensure data
            privacy and security including through various hardware and software
            methodologies. However, (mena-speakers.com) cannot guarantee the
            security of any information that is disclosed online’’
          </p>
          <p>
            "https://mena-speakers.com is not responsible for the privacy
          ...
          <p>
            ...
            <span className={"font-semibold"}>
              To start a return, you can contact us at info@mena-speakers.com.
          ...
          <p>
            We deliver our Products to all Countries and mainly UAE. Shipping
            will be done by a third-party courier. Delivery within UAE cities
            shall be in 1 – 2 working days and from 4 to 10 working Days to
            Other Countries. UAE Delivery Fees will be a Flat Rate of AED: 20
            and Delivery Fees outside UAE will be mentioned on the checkout page
            depending on the country and location. Avoid any delivery delay by
            providing your full address along with your contact details.
          </p>

          <p>
            <b>Damages and Issues</b> Please inspect your order upon reception
            and contact us immediately if the item is defective, damaged or if
            you receive the wrong item, so that we can evaluate the issue and
            make it right.
          </p>
          <p>
          ...
          <p>
            The multiple booking / orders / shipments may result in multiple
            postings to the cardholder’s monthly statement.
          </p>
