        ...
        <div className="w-full px-4 py-4 pt-12 space-y-1 bg-gradient-to-t from-black/90 to-black/0">
...

          {
            ...
            <div className={'flex items-center'}>
              <svg className={'mr-2 w-10 h-10'} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          {
            showActions && (
              <div className={'flex justify-between pt-4 items-center px-6'}>
                <Link className={'py-2 px-3 bg-white text-mena-100 rounded-xl text-sm'} href={route('speakers.show', speaker.slug)}>
                  See Profile
                </Link>
                <Link className={'py-2 px-3 text-white bg-mena-100 rounded-xl text-sm'} href={route('speakers.show', speaker.slug)}>
                  Explore
                </Link>
              </div>
            )
