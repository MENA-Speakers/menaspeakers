...
function HomeOurPartners() {
  return (
    <section className="max-w-7xl mx-auto  lg:px-0">
      <div className="">
        <h3 className="text-4xl font-semibold text-mena-brand">
          Our Clients
        </h3>
      </div>
      <div
        className="mt-6 py-4 flex flex-wrap gap-4 justify-items-center justify-center">
        <div className={'mt-4'}>
          <svg className={'h-10'} xmlns="http://www.w3.org/2000/svg" viewBox="-153.6 -69.186 1331.2 415.113">
            <path fill="#d81f26"
