      ...
      <div className="max-w-7xl mx-auto pb-12 flex flex-col lg:flex-row items-center justify-between">
        <div className="w-full lg:w-2/3 space-y-3">
          ...
          <div className="flex items-center group">
            <Phone size={20} className={'text-slate-300 group-hover:text-white mr-2 stroke-1'}/>
            <a href="tel:+971 52 630 6673" className={'text-slate-300 hover:text-white'}>+971 52 630 6673</a>
          </div>
          <div className="flex items-center group">
        ...
        <div className="w-full lg:w-1/3 pt-8 lg:pt-0 gap-8">
          ...
          <nav className="mt-4 flex  ">
              ...
              <div className="w-full lg:w-1/2">
                <Link href={'/topics'} className={'text-slate-300 hover:text-white block py-2'}>Topics</Link>
                <Link href={'/blogs'} className={'text-slate-300 hover:text-white block py-2'}>Blogs</Link>
              </div>
            </nav>
          </div>
